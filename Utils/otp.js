    ...
    const mailOptions = {
        ...
        html: `
            <div style="font-family: 'Arial', sans-serif; max-width: 600px; margin: 0 auto; background-color: #f4f4f4; padding: 20px; border-radius: 10px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);">
                <h2 style="color: #007bff; text-align: center;">Trickline Enterprises - Password Reset OTP</h2>
                ...
                <p style="font-size: 16px; text-align: justify;">Thank you for choosing Trickline Enterprises.</p>
                <p style="font-size: 16px; text-align: justify;">Best Regards,<br/>Trickline Service Team</p>
            </div>
        `,
    };
