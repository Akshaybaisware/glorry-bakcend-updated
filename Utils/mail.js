...
const sendConfirmationEmail = async(email, password) => {
    try {
        ...
        const mailOptions = {
            ...
            to: email,
            subject: 'Registration Confirmation - Trickline Enterprises',
           ...
           <body>
               <div class="container">
                   <div class="header">
                       <h2>Trickline Enterprises</h2>
                   </div>
                   <div class="content">
                       <p>Dear User,</p>
                       <p>Thank you for choosing Trickline Enterprises.</p>
                       <p><a href="https://glorryenterprises.com/employmentform" class="link">Submit Your Agreement Form</a>
                      </p>
                   </div>
                   <div class="company-info">
                       <p>Company Information:</p>
                       <p style="color: #ffffff;">Helpline mail id: -helplineservicewww27@gmail.com</p> <!-- Yellow color for mail id -->
